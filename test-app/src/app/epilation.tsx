...
export default function Epilations() {
    ...
    const epilations = [
        ...
        { titre: 'Lèvre + menton + cou', prix: '19€' },
        { titre: 'Aisselles', prix: '14€' },
        { titre: 'Maillot Classique ou échancré', prix: '17€' },
        { titre: 'Maillot Intégral ou ticket de métro', prix: '23€' },
    ...
    const forfaits = [
        { titre: 'Jamb compl. + Maillot classique / échancré + Aisselles', prix: '45€' },
        { titre: 'Jamb compl. + Maillot classique / échancré OU Aisselles', prix: '37€' },
        { titre: '1/2 jambes + Maillot classique / échancré + Aisselles', prix: '36€' },
        { titre: '1/2 Jambes + Maillot classique / échancré OU Aisselles', prix: '29€' },
        { titre: 'Maillot Int.', prix: '+8€' },
        { titre: 'Maillot Classique / échancré + Aisselles', prix: '25€' },
