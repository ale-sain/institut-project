...
export default function SoinVisage() {
    const soins = [
        { titre: 'LE PURIFIANT JUNIOR', duree: '40 min', prix: '38€', description : 'Parce qu\'on a - de 20 ans et que c\'est pénible les boutons !' },
        { titre: 'LE SPECIFIQUE PERSONNALISE', duree: '1 heure', prix: '55€', description : 'Parce qu\'on a pas tous la même peau… \nBesoin d\'hydratation, de nutrition, de douceur ou de pureté ? Après un diagnostic professionnel de votre peau, les produits seront adaptés aux problèmes de votre peau. Gommage, masque et massage se succèdent pour sublimer votre peau. Elle est radieuse de fraîcheur et de beauté.' },
        { titre: 'LE COCOONING', duree: '1 heure', prix: '60€', description : 'Nuageux, voluptueux…\nUn véritable bain de nutrition pour un maximum d\'éclat. Laissez-vous envoûter par l\'immortelle des mers' },
        { titre: 'LE NUTRITION JEUNESSE', duree: '1 heure', prix: '60€', description : 'Soin du visage pour réparer et nourrir les peaux sèches. Son thermomasque comble la peau d\'actifs ultra concentrés et procure une relaxation grâce à son effet chauffant. La peau est protégée, repulpée et confortable.' },
        { titre: 'LE MAGNIFIQUE', duree: '1 heure', prix: '60€', description : 'Une peau incroyablement belle…\nIssue de 5 années de recherche l\'actif breveté pylawhite extrait d\'une macro algue agit au cœur des cellules pour estomper les tâches brunes et retrouver un teint lumineux' },
        { titre: 'L\'HYDRA MINERAL', duree: '1 heure', prix: '60€', description : 'Désaltère et repulpe l\'épiderme. Il redonne vie aux peaux les plus déshydratées et dévitalisées.\nUn confort exceptionnel' },
        { titre: 'L\'ALGO CALM', duree: '1 heure', prix: '60€', description : 'Calme, apaise et réconforte les peaux fragiles et sensibles.\nLa peau retrouve son équilibre et révèle sa beauté.' },
        { titre: 'L\'ALGO ENERGIE', duree: '1 heure', prix: '60€', description : 'Réveille l\'éclat du teint, apporte un shot d\'énergie, détoxifie la peau, renforce la fonction barrière.\nIdéal pour les peaux fatiguées\nLa peau est plus lumineuse, plus fraîche et revitalisée' },
